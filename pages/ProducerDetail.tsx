            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <div className="inline-flex items-center gap-2 bg-primary/90 backdrop-blur text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider mb-4">
                        <span className="material-symbols-outlined text-[16px]">verified</span> Productor Verificado
                    </div>
      ...
      <div className="w-full max-w-7xl px-4 md:px-10 py-10 flex flex-col lg:flex-row gap-12 mx-auto">
        ...
        <div className="w-full lg:w-[400px] shrink-0 flex flex-col gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-[#e5e7eb] shadow-sm">
             ...
             <div className="rounded-2xl overflow-hidden h-48 relative border border-[#e5e7eb]">
                 <div className="absolute inset-0 bg-cover bg-center grayscale opacity-80" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAY0bLfl2A4Lwa2s9cNXDQjxiZhKIBXJz8M1XnonaRryguV-DmTfqJVuFBsEZyAgNk1pyw3PB9mrGteReIyS4_ZN8VI__Yi9IRGGcJtnBSgK7Yc7mo7t6KCQMfDXH3h5cdaErYbt_Stwu_NXMPreuJ-hXQ0RmwlAZ8-U7RfJz_71j4ryPar1NF0y708hKuIu2yX3sNraA37jrly-DcqFShwAgvTv2XYMXiveUY0JuWJiMcqy8gaZEMy9TwyyK9dg9HB4MQipCeoidKE')" }}></div>
                  <div className="absolute inset-0 bg-primary/10 flex items-center justify-center">
                        <button className="bg-white text-[#161613] px-4 py-2 rounded-lg text-sm font-bold shadow-md hover:scale-105 transition-transform flex items-center gap-2">
                             <span className="material-symbols-outlined text-primary">map</span> Ver Ubicación
                        </button>
                  </div>
             </div>
        </div>
       ...
       <div className="fixed bottom-0 left-0 w-full bg-white border-t border-[#e5e7eb] p-4 lg:px-10 z-30 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
                 <div className="hidden md:flex flex-col">
                    <span className="text-xs text-[#7f806b] font-medium uppercase tracking-wider">¿Interesado en este productor?</span>
                    <span className="text-sm font-medium text-[#161613]">Contacta directamente para negociar precios.</span>
                 </div>
                 <div className="flex items-stretch gap-4 w-full md:w-auto">
                    <button className="hidden md:flex flex-1 md:flex-none min-w-[160px] items-center justify-center rounded-xl h-14 border-2 border-[#e5e7eb] text-[#161613] font-bold hover:bg-[#f7f8f6] transition-colors gap-2">
                         <span className="material-symbols-outlined">download</span> Descargar Catálogo
                    </button>
                    <button className="flex-1 md:flex-none min-w-[280px] h-14 bg-primary hover:bg-[#7a7e32] text-white rounded-xl font-bold text-lg shadow-lg shadow-primary/30 flex items-center justify-center gap-3 transition-all active:scale-95">
                         <span className="material-symbols-outlined text-[24px]">chat</span> Contactar por WhatsApp
                    </button>
                 </div>
            </div>
       </div>
